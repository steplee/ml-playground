...
# Model params
the_latent_size = 256
the_conv_channels = [(32,True),(16,True)] # [(channels, downsample_after)]
...
def run(sess=None):
    ...
    try:
        ...
        net = vae.vae_cnn(x_in=dnext, conv_channels=the_conv_channels,
        ...
        print("\n\nDo you want to overwrite saves/{}? (y/n)".format(flags.name))
        yes = 'y' in sys.stdin.readline()
        if yes:
            net.save(sess)
